...
const Sidebar = () => {
  ...
  const normalLink = 'flex items-center gap-3 hover:bg-primary p-3 justify-center xl:justify-startcursor-pointer fornt-semibold text-[#F51997] rounded';
  ...
  return (
    <div>
      ...
      {showSidebar && (
        ...
        border-gray-100 xl:border-0 p3'>
                ...
                <GoogleLogin 
                  ...
                  render={(renderProps) => (
                      <button
                        ...
                        border-[1px] border-[#F51997] font-semibold px-6 py-3 rounded-md outline-none
